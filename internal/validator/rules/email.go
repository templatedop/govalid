...
func (e *emailValidator) JSONFieldName() string {
...
func (e *emailValidator) Err() string {
	...
	const errTemplate = `
		...
		[@ERRVARIABLE] = govaliderrors.ValidationError{Reason: "[@JSONFIELD] must be a valid email address", Path: "[@PATH]", Type: "[@TYPE]"}
	`
