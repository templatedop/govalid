...
func (v *fqdnValidator) JSONFieldName() string {
...
func (v *fqdnValidator) Err() string {
	...
	const errTemplate = `
		...
		[@ERRVARIABLE] = govaliderrors.ValidationError{Reason: "[@JSONFIELD] must be a fully qualified domain name", Path: "[@PATH]", Type: "[@TYPE]"}
	`
