...
func (v *iscolourValidator) JSONFieldName() string {
...
func (v *iscolourValidator) Err() string {
	...
	const errTemplate = `
		...
		[@ERRVARIABLE] = govaliderrors.ValidationError{Reason: "[@JSONFIELD] must be a valid color format", Path: "[@PATH]", Type: "[@TYPE]"}
	`
