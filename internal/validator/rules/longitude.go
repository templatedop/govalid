...
func (v *longitudeValidator) JSONFieldName() string {
...
func (v *longitudeValidator) Err() string {
	...
	const errTemplate = `
		...
		[@ERRVARIABLE] = govaliderrors.ValidationError{Reason: "[@JSONFIELD] must be a valid longitude (-180 to 180)", Path: "[@PATH]", Type: "[@TYPE]"}
	`
