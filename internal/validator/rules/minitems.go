...
func (m *minItemsValidator) JSONFieldName() string {
...
func (m *minItemsValidator) Err() string {
	...
	const errTemplate = `
		...
		[@ERRVARIABLE] = govaliderrors.ValidationError{Reason: "[@JSONFIELD] must have a minimum of [@VALUE] items", Path: "[@PATH]", Type: "[@TYPE]"}
	`
