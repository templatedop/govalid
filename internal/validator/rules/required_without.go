...
func (r *required_withoutValidator) JSONFieldName() string {
...
func (r *required_withoutValidator) Err() string {
	...
	const errTemplate = `
		...
		[@ERRVARIABLE] = govaliderrors.ValidationError{Reason: "[@JSONFIELD] is required when any of [@FIELDS] are absent", Path: "[@PATH]", Type: "[@TYPE]"}
	`
